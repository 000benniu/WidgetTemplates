...
<#macro dump key data>
    <#-- https://freemarker.sourceforge.io/docs/ref_builtins_expert.html#ref_builtin_isType -->
    ...
    <#elseif data?is_hash_ex>
        ...
        <@printHashEx data,[] />
    <#else>
        other:<@printItem data?if_exists,[], key, false />
    </#if>
</#macro>
...
<#macro printList list has_next_array>
    <#local counter=0 />
    <#list list as item>
        <#list has_next_array+[true] as has_next>
            <#if !has_next>    <#else>  | </#if>
        </#list>
        <#list has_next_array as has_next>
            <#if !has_next>    <#else>  | </#if>
        </#list>
        <#t><#t><@printItem item?if_exists,has_next_array+[item_has_next], counter, false />
...
<#macro printHashExFull hash has_next_array>
    <#list hash?keys as key>
        ...
        <#t><#t><@printItem hash[key]?if_exists,has_next_array+[key_has_next], key, true />
    </#list>
</#macro>
